...
!(function(e, t) {
    ...
    function d(e) {
        ...
        return (
            ...
            1 >= Math.abs(n.height - r) && (r = n.height), { x: e.offsetLeft, y: e.offsetTop, width: o, height: r }
        );
    }
    ...
    function y(e) {
        ...
        if (!o)
            e: {
                if (
                    ((o = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox")), -1 === navigator.userAgent.indexOf("Trident") ||
                        !i(e) ||
                        "fixed" !== c(e).position)
                )
